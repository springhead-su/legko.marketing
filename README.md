...
- Описания ко всем фильтрам по всем категориям
- Списки фильтров по категориям
- Второстепенные фильтры во всех категориях
- Дизайн и расположение второстепенного фильтра
- Дизайн и расположение кнопки сброса фильтров
- Дизайн карточки товара из оптимального выбора при отключенном оптимальном выборе
